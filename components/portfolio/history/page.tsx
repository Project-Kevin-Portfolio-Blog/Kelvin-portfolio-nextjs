...
export default function HistoryPage() {
  return (
    <div 
      data-aos="fade-in"
      className="min-h-screen px-8 pt-16 pb-8 bg-gradient-to-br from-gray-50  to-blue-50 dark:from-gray-900 dark:to-gray-800"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <span className="text-3xl text-blue-500 mb-4 block">
            <FaBitcoin />
          </span>
